# -*- coding: utf-8 -*-
"""
Created on Sun Oct  8 00:46:08 2023
...
# Home Maintenance
home_maintenance_data = st.session_state.get('home_maintenance_data', [])
...
if st.button("Add Task"):
    ...
    st.session_state.home_maintenance_data = home_maintenance_data
...
if st.button('Covid'):
    # Run the weather.py script
    subprocess.Popen(["streamlit", "run", "untitled11.py"])
